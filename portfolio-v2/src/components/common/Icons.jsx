...
// Clean, scalable icons to replace emojis
...
export const MusicNoteIcon = ({ size = 24, className = '' }) => (
  <svg
    ...
    className={className}
  >
    <path d="M12 3v13.55c-.94-.54-2.1-.75-3.33-.32-1.34.48-2.37 1.67-2.61 3.07-.26 1.48.38 2.99 1.62 3.88 1.24.89 2.92.89 4.16 0 1.24-.89 1.88-2.4 1.62-3.88-.14-.81-.51-1.54-1.03-2.12V6.83l8-2.4v9.12c-.94-.54-2.1-.75-3.33-.32-1.34.48-2.37 1.67-2.61 3.07-.26 1.48.38 2.99 1.62 3.88 1.24.89 2.92.89 4.16 0 1.24-.89 1.88-2.4 1.62-3.88-.14-.81-.51-1.54-1.03-2.12V3.44z" />
  </svg>
);
...
export const SettingsIcon = ({ size = 24, className = '' }) => (
  ...
  >
    ...
    <path d="M12 1v6m0 6v6m5.2-13.2-4.2 4.2m-2 2-4.2 4.2M23 12h-6m-6 0H5m13.2 5.2-4.2-4.2m-2-2-4.2-4.2" />
  </svg>
);
...
export const VolumeIcon = ({ size = 24, className = '' }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const VolumeOffIcon = ({ size = 24, className = '' }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
